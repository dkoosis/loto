...
// silently shrank, and the same-session beacon waiver then read the
// downgraded row as this session's own beacon and waived it, letting a
// tree-move proceed over uncommitted work — the 2026-08-14 incident,
