...
✓ done
- All 3 P2 audit bugs shipped + merged: #155 loto-h85e (orphan-restore TOCTOU), #156 loto-pody (unlock --all guard), #157 loto-kwlp (proc-start-time vs PID-reuse). Beads closed, branches/worktrees cleaned.
